(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@babel/runtime/helpers/defineProperty'), require('@babel/runtime/helpers/slicedToArray'), require('@babel/runtime/helpers/objectWithoutProperties'), require('react'), require('@babel/runtime/helpers/taggedTemplateLiteral'), require('styled-components/primitives')) :
    typeof define === 'function' && define.amd ? define(['exports', '@babel/runtime/helpers/defineProperty', '@babel/runtime/helpers/slicedToArray', '@babel/runtime/helpers/objectWithoutProperties', 'react', '@babel/runtime/helpers/taggedTemplateLiteral', 'styled-components/primitives'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['@octaldev/react-modal'] = {}, global._defineProperty, global._slicedToArray, global._objectWithoutProperties, global.React, global._taggedTemplateLiteral, global.styled));
    ...
    var Modal$1 = function Modal(_ref) {
      var style = _ref.style;
          _ref.card;
          var rest = _objectWithoutProperties__default['default'](_ref, ["style", "card"]);
      ...
      }, /*#__PURE__*/React__default['default'].createElement(Overlay, null)), props.card === true ? /*#__PURE__*/React__default['default'].createElement(Card, null, Child) : Child);
    };
